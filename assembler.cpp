...
void assembler::loadOPTAB()
{
    ...
    OPTAB["lda"] = make_pair(3,0x000000);
    OPTAB["sta"] = make_pair(3,0x0c0000);
    OPTAB["ldb"] = make_pair(3,0x680000);
    OPTAB["stb"] = make_pair(3,0x780000);
    OPTAB["ldl"] = make_pair(3,0x080000);
    OPTAB["stl"] = make_pair(3,0x140000);
    OPTAB["ldt"] = make_pair(3,0x740000);
    OPTAB["stt"] = make_pair(3,0x840000);
    OPTAB["ldx"] = make_pair(3,0x040000);
    OPTAB["stx"] = make_pair(3,0x100000);
    OPTAB["lds"] = make_pair(3,0x6c0000);
    OPTAB["sts"] = make_pair(3,0x7c0000);
    OPTAB["ldch"] = make_pair(3,0x500000);
    OPTAB["stch"] = make_pair(3,0x540000);
    ...
    OPTAB["j"] = make_pair(3,0x3c0000);
    OPTAB["jeq"] = make_pair(3,0x300000);
    OPTAB["jlt"] = make_pair(3,0x380000);
    OPTAB["jgt"] = make_pair(3,0x340000);
    ...
    OPTAB["tix"] = make_pair(3,0x2c0000);
